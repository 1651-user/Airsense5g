...
class HealthProfileFormScreen extends StatefulWidget {
  ...
  const HealthProfileFormScreen(
      {super.key, required this.userId, this.existingProfile});
...
class _HealthProfileFormScreenState extends State<HealthProfileFormScreen> {
  ...
  void initState() {
    ...
    if (widget.existingProfile != null) {
      ...
      _selectedConditions.addAll(widget.existingProfile!.conditions);
      _selectedActivity = widget.existingProfile!.activityLevel;
      // Map string sensitivity to double if possible, or default
      if (widget.existingProfile!.pollutionSensitivity == 'Low')
        _sensitivityLevel = 1.0;
      else if (widget.existingProfile!.pollutionSensitivity == 'High')
        _sensitivityLevel = 5.0;
      else
        _sensitivityLevel = 3.0; // Medium

      // Try parsing numeric if stored as such
      final double? parsedSens =
          double.tryParse(widget.existingProfile!.pollutionSensitivity);
      if (parsedSens != null) _sensitivityLevel = parsedSens;
    }
  }
  ...
  Future<void> _submitProfile() async {
    ...
    final profile = HealthProfile(
      ...
      pollutionSensitivity:
          _sensitivityLevel.toStringAsFixed(1), // Store as string "3.0"
    ...
    if (result['success'] == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(result['error'] ?? 'Failed to create profile'),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                          child: Text(
                              'Complete your health profile to receive personalized air quality alerts',
                              style: Theme.of(context)
                                  .textTheme
                                  .bodySmall
                                  ?.copyWith(
                ...
                const SizedBox(height: 32),
                Text(
                    'Pollution Sensitivity: ${_sensitivityLevel.toStringAsFixed(0)}/5',
                ...
                SliderTheme(
                  ...
                  child: Slider(
                    ...
                    max: 5.0,
                    divisions: 4,
                    label: _sensitivityLevel.round().toString(),
                    onChanged: (value) {
                      setState(() {
