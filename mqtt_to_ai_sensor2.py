"""
Integrated MQTT to AI Pipeline - Sensor 2

This script:
1. Connects to MQTT broker (sensor 2)
...
# Load environment variables for Sensor 2
load_dotenv('amb2.env')

# MQTT Configuration
MQTT_BROKER = os.getenv('MQTT_BROKER', 'au1.cloud.thethings.industries')
MQTT_PORT = int(os.getenv('MQTT_PORT', '1883'))
MQTT_TOPIC = os.getenv('MQTT_TOPIC', 'v3/milesight-aqi@lora-demo/devices/ambience-2/up')
...
# File paths
JSON_FILE = 'mqtt_data_sensor2.json'
MODEL_DIR = 'models'
SENSOR_ID = 2
...
def main():
    ...
    try:
        ...
        print(f"  2. MQTT credentials in amb2.env")
