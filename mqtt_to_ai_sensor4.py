...
# Load environment variables for Sensor 4
load_dotenv('amb4.env')

# MQTT Configuration
MQTT_BROKER = os.getenv('MQTT_BROKER', 'au1.cloud.thethings.industries')
MQTT_PORT = int(os.getenv('MQTT_PORT', '1883'))
MQTT_TOPIC = os.getenv('MQTT_TOPIC', 'v3/milesight-aqi@lora-demo/devices/ambience-4/up')
...
# File paths
JSON_FILE = 'mqtt_data_sensor4.json'
MODEL_DIR = 'models'
SENSOR_ID = 4
...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        if 'uplink_message' in payload and 'decoded_payload' in payload['uplink_message']:
            ...
            # FIX: Sensor 4 has incorrect MQTT field mapping (like Sensor 5)
            # The 'battery' field actually contains PM2.5 data (values like 88)
            # Real battery should be 100% most of the time
            if 'battery' in sensor_data and sensor_data['battery'] > 80:
                # Swap battery value to PM2.5
